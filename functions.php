...
function project_post_type() {
    ...
    $args = array(
         ...
         */
        'taxonomies'            => array(),/*not using*/
        'labels' => array(
            'name'               => __( 'Projects',                   'project-textdomain' ),
            'singular_name'      => __( 'Project',                    'project-textdomain' ),
            'menu_name'          => __( 'Projects',                   'project-textdomain' ),//we can change name 
    ...
    register_post_type(
        'project', // Post type name. Max of 20 characters. Uppercase and spaces not allowed.//exact same name with archive-name
...
include ('components/theme-support.php');
include ('components/media.php');
include('components/taxonomies.php');
 ?>
